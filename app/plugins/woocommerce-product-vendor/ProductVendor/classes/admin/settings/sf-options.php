...
$options[ ] = array( 'name' => __( 'Capabilities', 'wc_product_vendor' ), 'type' => 'heading' );
$options[ ] = array( 'name' => __( 'Permissions', 'wc_product_vendor' ), 'type' => 'title', 'desc' => __( 'General permissions used around the shop', 'wc_product_vendor' ) );
