                        ...
                        <div class="ui-draggable" id="draggable" style="width: 600px; height: 600px; position: relative;">
                            <div class="ui-tabs ui-widget ui-widget-content ui-corner-all" id="tabs" style="border:1px solid #000000; background-image:url('<?php echo HYBRIDCONNECT_IAMGES_PATH ?>/dragBackground.png'); background-repeat:repeat-y;">
                                <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                                    ...
                                    <li <?php if ($variation->control == 0): ?>style="display:none;"<?php endif ?> class="ui-state-default-cancel ui-corner-top"><a id="squeezePagesShow" href="#tabs-5">Squeeze Page Settings</a></li>
                                </ul>
                                ...
                                <?php include_once 'builder/hc_admin_tpl_squeeze_tab.php' ?>
                            </div>
...
<script type="text/javascript">
    ...
    function try_save(type) {
        ...
        var style_config_object = {
            ...
            sq_centre_aligned: jQuery("#centredOnScreen").attr("checked"),
            sq_vertically_aligned: jQuery("#verticallyAligned").attr("checked"),
            sq_vertical_top_margin: jQuery("#optinTopMargin").val(),
            sq_background_color: jQuery("#squeezeBGColor").val(),
            sq_bg_gradient_checkbox: jQuery("#squeezeGradientCheckbox").attr('checked'),
            sq_bg_picture_checkbox: jQuery("#squeezePictureCheckbox").attr('checked'),
            sq_gradient_bg_color_1: jQuery("#squeezeGradientBGColor1").val(),
            sq_gradient_bg_color_2: jQuery("#squeezeGradientBGColor2").val(),
            sq_image_bg_file: jQuery("#squeezeImageBackgroundUploadFilePath").val(),
            sq_tile_bg: jQuery("#squeezeTileBG").attr("checked"),
            sq_bg_repeat_x_axis: jQuery("#repeatXAxis").attr("checked"),
            sq_bg_repeat_y_axis: jQuery("#repeatYAxis").attr("checked"),
            sq_squeeze_enabled : jQuery("#squeezeEnabled").attr('checked'),
            sq_squeeze_page_show : jQuery("#squeezePageShow").val(),
