 <?php if(empty($hc_tests_list)) { echo '<div class="ui-state-highlight ui-corner-all" style="margin-top: 20px; padding: 0 .7em;">
    ...
    <thead>
        <tr>
            <th style="font-size: 1.1em;">Test Type</th>
            <th style="font-size: 1.1em;">Test Started</th>
            <th style="font-size: 1.1em;">Test Ended</th>
            <th style="font-size: 1.1em;">Show Test Details</th>
        </tr>
    </thead>
    <tbody>
 ...
 <?php foreach($hc_tests_list as $thisTest) { ?>
            ...
            <span class="ui-icon ui-icon-pencil" style="width:16px; float:left; margin:0px; padding:0px;"></span>Show Test Results</li></a>
            </td>
        </tr>
<?php   } // end foreach
unset($thisTest);
