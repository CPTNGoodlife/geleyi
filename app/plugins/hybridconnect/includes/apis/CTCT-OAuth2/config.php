...
$apikey = "d7e0f743-e2e3-4691-8a42-d42d730874e4";

// Consumer secret is issued with an apikey
$consumersecret = "f8b4e5597ec840a69ff69528ce38a5c9";

// Redirect URL which is set when creating your API key, this must match up 
// or you will receive an error
$verificationURL = 'http://gvs.ro/cc/example_verification.php';
