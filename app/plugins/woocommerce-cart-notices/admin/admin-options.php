 ...
 * @global Woocommerce $woocommerce woocommerce class
 *
...
global $wc_cart_notices, $woocommerce;

/* show any error messages */
$wc_cart_notices->admin_message_handler->show_messages(); ?>
<style type="text/css">
				...
				<td>
					...
					switch ( $notice->type ) {
						case 'minimum_amount':
							...
							echo sprintf( __( "Threshold amount: %s", WC_Cart_Notices::TEXT_DOMAIN ), isset( $notice->data['threshold_order_amount'] ) ? get_woocommerce_currency_symbol() . $notice->data['threshold_amount'] : "none configured" );
						break;
						case 'deadline':
		...
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					<th scope="row">
						...
						<span class="description">
							...
							<ul>
								<li><strong>{amount_under}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Minimum Amount' this is the amount required to meet the minimum order amount.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
								<li><strong>{time}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Deadline' this is the amount of time remaining, ie '1 hour 15 minutes' or '25 minutes', etc.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
								<li><strong>{products}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Products in Cart' or 'Categories in Cart' these are the matching product names.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
								<li><strong>{quantity}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Products in Cart' this is the product quantity.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
								<li><strong>{quantity_under}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Products in Cart' and 'Maximum Quantity for Notice' configured this is the product quantity less than the maximum.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
								<li><strong>{quantity_over}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Products in Cart' and 'Minimum Quantity for Notice' configured this is the product quantity over the minimum.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
								<li><strong>{categories}</strong> <img class="help_tip" width="16" height="16" title="<?php _e( "With type 'Categories in Cart' these are the matching category names.", WC_Cart_Notices::TEXT_DOMAIN ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
							</ul>
						</span>
					</th>
					<td>
				...
				<tr valign="top" class="products_notice_data notice_data" style="<?php echo 'products' != $notice->type ? 'display:none;' : ''; ?>">
					...
					<td>
						<select id="product_ids" name="product_ids[]" class="ajax_chosen_select_products_and_variations" multiple="multiple" data-placeholder="<?php _e( 'Search for a product&hellip;', WC_Cart_Notices::TEXT_DOMAIN ) ?>">
						<?php
				...
				<tr valign="top" class="products_notice_data notice_data" style="<?php echo 'products' != $notice->type ? 'display:none;' : ''; ?>">
					...
					<td>
						...
						<?php
							foreach ( $woocommerce->countries->countries as $code => $name ) :
				...
				<tr valign="top" class="categories_notice_data notice_data" style="<?php echo 'categories' != $notice->type ? 'display:none;' : ''; ?>">
					...
					<td>
						<select id="category_ids" name="category_ids[]" class="ajax_chosen_select_product_categories" multiple="multiple" data-placeholder="<?php _e( 'Search for a category&hellip;', WC_Cart_Notices::TEXT_DOMAIN ) ?>">
						<?php
