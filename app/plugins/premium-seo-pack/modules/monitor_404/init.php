			...
			<div id="psp-lightbox-overlay">
				<div id="psp-lightbox-container">
					<h1 class="psp-lightbox-headline">
						...
						<span id="link-add-redirect"><?php _e('Add to Link Redirect:', $this->the_plugin->localizationName);?></span>
						...
						<div id="psp-lightbox-seo-report-response2">
							<form class="psp-update-link-form">
								...
								<table width="100%">
									...
									<tr>
										<td><label><?php _e('URL Redirect:', $this->the_plugin->localizationName);?></label></td>
										<td><input type="text" id="new_url_redirect2" name="new_url_redirect2" value="" class="psp-add-link-field" /></td>
									</tr>
									<tr>
										<td></td>
										<td>
											<input type="button" class="psp-button green" value="<?php _e('Add to Link Redirect', $this->the_plugin->localizationName); ?>" id="psp-submit-to-builder2">
										</td>
									</tr>
								</table>
	                        	...
	                        	<div class="psp-panel">
	                        		<div class="psp-panel-header">
										<span class="psp-panel-title">
											...
											<?php _e('Monitor Page Not Found Errors', $this->the_plugin->localizationName);?>
										</span>
									</div>
