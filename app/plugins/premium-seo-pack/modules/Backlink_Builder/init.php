			...
			<div id="psp-lightbox-overlay">
				<div id="psp-lightbox-container">
					<h1 class="psp-lightbox-headline">
						<span style="left: 10px;"><?php _e('The submit status was:', $this->the_plugin->localizationName);?></span>
					...
					<div class="psp-seo-status-container" style="margin: 30px 0 0;">
						...
						<div id="psp-lightbox-backlink-builder-response" style="text-align: center;">
							<br /><br />
							<a href="#" data-status="success" class="psp-button green psp-submit-status"><?php _e('Success submited', $this->the_plugin->localizationName);?></a>&nbsp;
							<a href="#" data-status="error" class="psp-button red psp-submit-status"><?php _e('Error on submit', $this->the_plugin->localizationName);?></a>
						</div>
	                        	...
	                        	<div class="psp-panel">
	                        		<div class="psp-panel-header">
										<span class="psp-panel-title">
											...
											<?php _e('Semi-automatic Backink Builder', $this->the_plugin->localizationName);?>
										</span>
									</div>
									<div class="psp-panel-content">
										<div style="display: none;" id="psp-submit-status-values">
											<div class="submit_never"><?php ( _e('Never submit', $this->the_plugin->localizationName) ); ?></div>
											<div class="submit_inprogress"><?php ( _e('Submit in progress', $this->the_plugin->localizationName) ); ?></div>
											<div class="submit_error"><?php ( _e('Error on submit', $this->the_plugin->localizationName) ); ?></div>
											<div class="submit_success"><?php ( _e('Submit successfully', $this->the_plugin->localizationName) ); ?></div>
											...
											pspAjaxListTable::getInstance( $this->the_plugin )
												->setup(array(
													...
													'columns'			=> array(
														...
														'submit_status'		=> array(
															'th'	=> __('Submit status', $this->the_plugin->localizationName),
															'td'	=> '%submit_status%',
															'align' => 'center',
															'width' => '120'
														),
														...
														'directory_name'		=> array(
															'th'	=> __('Directory Name', $this->the_plugin->localizationName),
															'td'	=> '%directory_name%',
															'align' => 'left'
														),
								...
								<div class="psp-panel">
									<div class="psp-panel-header">
										<span class="psp-panel-title"> 
											...
											<?php _e('Autofill options', $this->the_plugin->localizationName);?>
										</span>
									</div>
									<div class="psp-panel-content">
										<form action="#save_with_ajax" id="psp_website_profile" class="psp-form">
											...
											<div class="psp-message" style="padding-left: 10px;">
												<?php _e('Drag this button to your bookmark bar:', $this->the_plugin->localizationName); ?>
												<a class="psp-button orange" style="display:inline-block; margin: 0px 0px 0px 10px; position: relative; bottom: -6px;" href="javascript:(function(){document.body.appendChild(document.createElement('script')).src='<?php echo $this->module_folder;?>/backlink.php';})();"><?php _e('Autofill', $this->the_plugin->localizationName); ?> <?php echo get_bloginfo();?> <?php _e('Metas', $this->the_plugin->localizationName); ?></a><br>
											</div>
											...
											<div class="psp-form-row">
												<label for="services"><?php _e('Your Name:', $this->the_plugin->localizationName); ?></label>
												<div class="psp-form-item large">
													<span class="formNote"><span style="color:red">*</span> <?php _e('This field is required.', $this->the_plugin->localizationName); ?></span>
											...
											<div class="psp-form-row">
												<label for="services"><?php _e('Your Email:', $this->the_plugin->localizationName); ?></label>
												<div class="psp-form-item large">
													<span class="formNote"><span style="color:red">*</span> <?php _e('This field is required.', $this->the_plugin->localizationName); ?></span>
											...
											<div class="psp-form-row">
												<label for="services"><?php _e('Title:', $this->the_plugin->localizationName); ?></label>
												<div class="psp-form-item large">
													<span class="formNote"><span style="color:red">*</span> <?php _e('This field is required.', $this->the_plugin->localizationName); ?></span>
											...
											<div class="psp-form-row">
												<label for="services"><?php _e('URL:', $this->the_plugin->localizationName); ?></label>
												<div class="psp-form-item large">
													<span class="formNote"><span style="color:red">*</span> <?php _e('This field is required.', $this->the_plugin->localizationName); ?></span>
											...
											<div class="psp-form-row">
												<label for="services"><?php _e('Meta Description:', $this->the_plugin->localizationName); ?></label>
												<div class="psp-form-item large">
													<span class="formNote"><?php _e('This field is not required.', $this->the_plugin->localizationName); ?></span>
											...
											<div class="psp-form-row">
												<label for="services"><?php _e('Meta Keywords:', $this->the_plugin->localizationName); ?></label>
												<div class="psp-form-item large">
													<span class="formNote"><?php _e('This field is not required.', $this->the_plugin->localizationName); ?></span>
											...
											<div class="psp-button-row">
												<input type="submit" class="psp-button green psp-saveOptions" value="<?php _e('Save the settings', $this->the_plugin->localizationName); ?>">
											</div>
										</form>
									</div>
								</div>
...
$pssBacklinkBuilder = new pssBacklinkBuilder($this->cfg, ( isset($module) ? $module : array()) );