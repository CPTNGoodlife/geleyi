					...
					<div class="psp-seo-status-container">
						<div id="psp-lightbox-seo-report-response">
							<form class="psp-add-link-form">
								<table width="100%">
									<tr>
										<td width="80"><label><?php _e('URL:', $this->the_plugin->localizationName);?></label></td>
	                        	...
	                        	<div class="psp-panel">
	                        		<div class="psp-panel-header">
										<span class="psp-panel-title">
											...
											<?php _e('301 Link Redirect', $this->the_plugin->localizationName);?>
										</span>
									</div>
...
$pspLinkRedirect = new pspLinkRedirect($this->cfg, ( isset($module) ? $module : array()) );