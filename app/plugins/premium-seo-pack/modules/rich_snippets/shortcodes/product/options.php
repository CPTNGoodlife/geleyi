			...
			'psp_rs_product' => array(
				...
				'elements'	=> array(
					...
					,'condition' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '200',
						'title' 	=> __('Condition:', $this->the_plugin->localizationName),
						'desc' 		=> 'select condition',
						'options'	=> array_merge( array('none' => __('Select condition', $this->the_plugin->localizationName)), $psp_product_condition )
					)
					,'availability' => array(
						'type' 		=> 'select',
						'std' 		=> '',
						'size' 		=> 'large',
						'force_width'=> '200',
						'title' 	=> __('Availability:', $this->the_plugin->localizationName),
						'desc' 		=> 'select availability',
						'options'	=> array_merge( array('none' => __('Select availability', $this->the_plugin->localizationName)), $psp_product_availability )
					)
