			...
			'psp_rs_organization' => array(
				...
				'elements'	=> array(
					...
					'orgtype' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '200',
						'title' 	=> __('Organization Type:', $this->the_plugin->localizationName),
					...
					,'country' => array(
						...
						'desc' 		=> 'select country',
						'options'	=> array_merge( array('none' => __('Select country', $this->the_plugin->localizationName)), $psp_countries_list )
					)
					,'map_latitude' 	=> array(
						'type' 		=> 'text',
						'std' 		=> '',
