    ...
    class pspLocalSEO
    {
        ...
        */
		...
		public function init_postType() 
		{
		    // get label
		    $labels = array(
		        'name' 					=> __('PSP Locations', $this->the_plugin->localizationName),
		        'singular_name' 		=> __('psp location', $this->the_plugin->localizationName),
		        'add_new' 				=> __('Add new location', $this->the_plugin->localizationName),
		        'add_new_item' 			=> __('Add new location', $this->the_plugin->localizationName),
		        'edit_item'			 	=> __('Edit location', $this->the_plugin->localizationName),
		        'new_item' 				=> __('New location', $this->the_plugin->localizationName),
		        'view_item' 			=> __('View location', $this->the_plugin->localizationName),
		        'search_items' 			=> __('Search into locations', $this->the_plugin->localizationName),
		        'not_found' 			=> __('No locations found', $this->the_plugin->localizationName),
		        'not_found_in_trash' 	=> __('No locations in trash', $this->the_plugin->localizationName)
		    );
	    ...
	    */
	    ...
	    {
	    	$screens = array(
	    		'psp_locations' => __( 'PSP Locations Details', $this->the_plugin->localizationName )
	    	);
		...
		?>
			...
			<div id="psp-meta-box-container" style="display:none;">
				...
				<div class="psp-tab-menu">
					<a href="#business_information" class="open"><?php _e('Business Information', $this->the_plugin->localizationName);?></a>
					<a href="#business_contact"><?php _e('Business Contact and Google Map', $this->the_plugin->localizationName);?></a>
					<a href="#opening_hours"><?php _e('Opening Hours', $this->the_plugin->localizationName);?></a>
					<a href="#other_details"><?php _e('Other details', $this->the_plugin->localizationName);?></a>
				</div>
					...
					'location' => array(
						...
						'elements'	=> array(
							'bname' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Business name:', $this->the_plugin->localizationName),
								//'force_width' => '150',
							...
							,'btype' => array(
								'type' 		=> 'html',
								'html' 		=> $this->business_type_list('btype', $defaults['location']['btype'])
							)
							
							,'description' => array(
								'type' 		=> 'textarea',
								'size' 		=> 'large',
								'title' 	=> __('Business description:', $this->the_plugin->localizationName),
								//'force_width' => '150',
							...
							,'url' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Business website URI:', $this->the_plugin->localizationName),
								//'force_width' => '150',
							...
							,'address' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Street Address:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							/*,'unit' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Unit Number:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'city' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('City:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'state' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('State / Region:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'zipcode' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Postal / Zip code:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
					...
					'location' => array(
						...
						'elements'	=> array(
							'phone' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Phone:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'phone_alt' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Alternative Phone:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'fax' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Fax:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'email' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Email:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'map_name' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Business name on the map:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							/*,'map_domain' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Google maps top level domain:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'map_latitude' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Google Map Latitude:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
								'readonly'	=> true,
							...
							,'map_longitude' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Google Map Longitude:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
								'readonly'	=> true,
								'desc' 		=> 'retrieved automatically based on your business address',
							...
							,'map_preview' => array(
								...
								'html' 		=> $this->google_map_preview( array(
									'latitude' 		=> $defaults['location']['map_latitude'],
									'longitude' 	=> $defaults['location']['map_longitude']
								) )
							)
					...
					'location' => array(
						...
						'elements'	=> array(
							'payment_forms' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Payment forms accepted:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'payment_currency' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Currencies accepted:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
							...
							,'payment_price_range' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Price range:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
					...
					'location' => array(
						...
						'elements'	=> array(
							'oh_heading' => array(
								'type' 		=> 'text',
								'size' 		=> 'large',
								'title' 	=> __('Opening Hours Header:', $this->the_plugin->localizationName),
								//'force_width' => '150',
								'std'		=> '',
								'desc' 		=> 'ex: Cash, Check, Visa, Paypal',
							)
							...
							,'openings_hours' => array(
								'type' 		=> 'html',
								'html' 		=> $this->opening_hours_tpl( $defaults['location']['oh'] )
							)
		...
		?>
				<label for='<?php echo $field_name; ?>' style=''><?php echo __('Day', $this->the_plugin->localizationName); ?>:</label>
		...
		?>
		<div class="psp-form-row">
			<label><?php _e('Business type:', $this->the_plugin->localizationName); ?>	</label>
		...
		<div class="psp-form-row">
			<label><?php _e('Google Map Preview:', $this->the_plugin->localizationName); ?>	</label>
		...
		public function locations_edit_columns($locations_columns) {
		    ...
		    $new_columns['locations_id'] 			= __('ID', $this->the_plugin->localizationName);
		    $new_columns['locations_thumbnail'] 	= __('Image', $this->the_plugin->localizationName);
		    $new_columns['title'] 					= __('Title', $this->the_plugin->localizationName);
		    $new_columns['date'] 					= __('Date', $this->the_plugin->localizationName);
		...
		public function meta_box_save_postdata( $post_id ) 
		{
			...
			if( isset($post) ) {
				...
				if($post->post_type == 'psp_locations') {
					...
					$options = array();
					$options = array_merge_recursive( $options, reset( $this->business_information_options() ) );
					$options = array_merge_recursive( $options, reset( $this->business_contact_options() ) );
					$options = array_merge_recursive( $options, reset( $this->opening_hours_options() ) );
					$options = array_merge_recursive( $options, reset( $this->other_details_options() ) );
					...
					if($nrOfOpenings > 0) {
						...
						for ($i=1; $i<= $nrOfOpenings; $i++) { 
							$openings[$i] = array(
								'day' => $_POST['oh'][$i]['day'],
								'from_hour' => $_POST['oh'][$i]['from_hour'],
								'from_min' => $_POST['oh'][$i]['from_min'],
								'to_hour' => $_POST['oh'][$i]['to_hour'],
								'to_min' => $_POST['oh'][$i]['to_min']
							);
						}
