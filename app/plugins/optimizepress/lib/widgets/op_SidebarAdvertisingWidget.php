...
class OP_SidebarAdvertisingWidget extends WP_Widget {
	...
	parent::WP_Widget(false, 'OptimizePress: Advertising Block', array('description' => sprintf(__('Displays ad blocks in the sidebar. Can be enabled and customized from the <a href="%s">Blog Settings > Modules > Sidebar Advertising</a> section.'), admin_url('admin.php?page=optimizepress-theme-settings#modules'))));
    }
    
    //Options form for admin section
    function form($instance){
	?>
	<p>To use this widget you must enable the Sidebar Advertising Module from the <a href="<?php echo admin_url('admin.php?page=optimizepress-theme-settings#modules'); ?>">Blog Settings > Modules</a> section of OptimizePress</p>
	<?php
    }
