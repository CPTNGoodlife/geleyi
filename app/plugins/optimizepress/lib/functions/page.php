...
function op_page_header($color=''){
	...
	if((($nav = op_get_var($header_layout,'nav_bar_above',array())) !== false) && op_get_var($nav,'enabled') == 'Y'):
		?>
			...
			<div class="fixed-width">
				<div class="twentyfour columns">
					...
					<nav class="navigation">
						<ul id="navigation-above">'.wp_nav_menu( array( 'menu' => $nav['nav'], 'walker' => new Arrow_Walker_Nav_Menu(), 'items_wrap' => '%3$s', 'container' => false, 'echo'=>false ) ).'
						</ul>
					</nav>';
					}
					?>
	...
	if($logoimg = op_page_option('header_layout','logo')){
	...
	?>
		<div class="banner<?php echo ($alongside? ' include-nav':'').$banner_class ?>"<?php echo $style ?>>
			<div class="fixed-width cf">
				...
				if($alongside && (($nav = op_get_var($header_layout,'nav_bar_alongside',array())) !== false) && op_get_var($nav,'enabled') == 'Y'):?>
				<div class="sixteen columns"><?php
					...
					<nav class="navigation fly-to-left">
						<ul id="navigation-alongside">'.wp_nav_menu( array( 'menu' => $nav['nav'], 'walker' => new Arrow_Walker_Nav_Menu(), 'items_wrap' => '%3$s', 'container' => false, 'echo'=>false ) ).'
						</ul>
					</nav>';
					?>
				</div>
		...
		<?php if((($nav = op_get_var($header_layout,'nav_bar_below',array())) !== false) && op_get_var($nav,'enabled') == 'Y'):
		?>
		<div class="nav-bar-below page-header<?php echo $color == '' ? '' :' page-header-'.$color ?> cf">
			<div class="fixed-width">
				<div class="twentyfour columns">
					...
					<nav class="navigation">
						<ul id="navigation-below">'.wp_nav_menu( array( 'menu' => $nav['nav'], 'walker' => new Arrow_Walker_Nav_Menu(), 'items_wrap' => '%3$s', 'container' => false, 'echo'=>false ) ).'
						</ul>
					</nav>';
					?>
				</div>
