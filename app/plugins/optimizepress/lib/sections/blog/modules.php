	...
	function sections(){
		...
		if(!isset($sections)){
			$sections = array(
				...
				'scripts' => array(
					'title' => __('Other Scripts', OP_T_SN),
					'module' => 'scripts',
					'options' => op_theme_config('mod_options','scripts'),
					'on_off' => false,
				),
				'continue_reading' => array(
					'title' => __('Continue Reading Links', OP_T_SN),
