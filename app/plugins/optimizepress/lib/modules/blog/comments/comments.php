...
'.$title.
($hide_like != 'Y' ? '
	<fb:like href="'.$src_url.'" send="false"'.$widthstr.' show_faces="false"'.$color_scheme.' font="arial"></fb:like>':'').'
	<fb:comments href="'.$src_url.'"'.$color_scheme.$widthstr.' num_posts="'.$posts_number.'" publish_feed="true" migrated="1"></fb:comments>
</div>';
// xid="'.$xid.'"
