...
class OptimizePress_Page_Lightbox_Module extends OptimizePress_Modules_Base {
	...
	function print_scripts(){
		if(!defined('OP_LIVEEDITOR')){
			wp_enqueue_script(OP_SN.'-module-lightbox',$this->url.'lightbox.js',array('jquery'),'2012-06-01');
			wp_enqueue_style(OP_SN.'-module-lightbox',$this->url.'lightbox.css',false,'2012-06-01');
		}
	}
