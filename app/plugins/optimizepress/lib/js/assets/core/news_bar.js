var op_asset_settings = (function($){
	return {
		...
		customInsert: function(attrs){
			...
			str = '[news_bar style="' + style + '" color="' + attrs.color + '" feature_text="' + attrs.feature_text + '" main_text="' + attrs.main_text + '"][/news_bar]';
		...
		customSettings: function(attrs,steps){
			var html = '',
				...
				feature_text = attrs.attrs.feature_text
				main_text = attrs.attrs.main_text;
