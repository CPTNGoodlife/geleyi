var op_asset_settings = (function($){
	...
	return {
		...
		customInsert: function(attrs){
			...
			str = '[bullet_block '+(attrs.style=='large'?'large_icon="'+attrs.large_icon+'"':'style="'+attrs.style+'" small_icon="'+attrs.small_icon+'"')+ ' width="' + attrs.width + '" alignment="' + attrs.alignment + '"' +str+']<ul>'+content+'</ul>[/bullet_block]';
