	...
	return {
		...
		customInsert: function(attrs){
			...
			$.each(attrs.steps, function(index, val){
				str += '[step style="' + style + '" text="' + val.text + '" headline="' + val.headline + '" information="' + val.information + '"][/step]';
			});
