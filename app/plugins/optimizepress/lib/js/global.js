...
(function($){
    ...
    function init_dropkick(){
        ...
        $(window).resize(function(){
                if (parseInt($(this).width())<960){
                        $(navSelector).each(function(){
                                var dd_containers = $(this).siblings('.dk_container');
                                if (dd_containers.length==0){
                                        $(this).dropkick({
                                                change: function () {
                                                        ('.dk').submit();
                                                }
                        ...
                        $(navSelector).prev('.dk_container').hide();
                }
        }).trigger('resize');
