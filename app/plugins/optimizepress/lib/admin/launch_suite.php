...
class OptimizePress_LaunchSuite {
	...
	function print_scripts(){
		...
		wp_enqueue_style( OP_SN.'-admin-launch-suite',  OP_CSS.'launch_suite.css', array(OP_SN.'-admin-common'), '2011-10-05' );
		wp_enqueue_script( OP_SN.'-admin-launch-suite',  OP_JS.'launch_suite.js', array(OP_SN.'-admin-common','jquery-ui-sortable'), '2011-10-05' );
	}
	...
	function save_launch_suite(){
		...
		$this->data['settings_sections'] = array(
			...
			'perpetual_launch' => __('Perpetual Launch Mode',OP_SN),
