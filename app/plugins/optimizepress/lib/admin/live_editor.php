...
'.$css.'
	...
	function update_feature(){
		...
		$this->init_page();
		//die('aaa' . print_r($GLOBALS['op_feature_area']));
	...
	function load_editor($post){
		...
		op_tpl_assign($data);
		require_once OP_PAGES.op_page_option('theme','type').'/'.op_page_option('theme','dir').'/template.php';
	}
	...
	function print_scripts(){
		...
		wp_enqueue_script( OP_SN.'-admin-live-editor',  OP_JS.'live_editor.js',array(OP_SN.'-admin-common','jquery-ui-sortable','swfupload-swfobject'), '2011-10-05' );
		wp_enqueue_style( OP_SN.'-admin-live-editor',  OP_CSS.'live_editor.css', array(OP_SN.'-admin-common'), '2011-10-05' );
		wp_enqueue_script(OP_SN.'-loadScript',  OP_JS.'jquery/jquery.loadScript.js');
