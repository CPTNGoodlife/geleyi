...
class OptimizePress_Dashboard {
	...
	function get_sections(){
		...
		if(!isset($this->sections)){
			...
			$sections = array(
				...
				'analytics_and_tracking' => 'Analytics and Tracking',
				'email_marketing_services' => 'Email Marketing Services',
	...
	function admin_menu(){
		...
		add_menu_page('OptimizePress', 'OptimizePress', 'edit_theme_options', OP_SN, array(),'','30');
	...
	function print_scripts(){
		...
		wp_enqueue_script( OP_SN.'-admin-common');
	}
