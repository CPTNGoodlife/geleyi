...
//	Instructions to use:
//
//	1. unzip Spunky123456's share: 
//		http://blankrefer.com/?http://www.mirrorcreator.com/files/0P1BTFUF/optimizepresstheme.zip_links
//		inside your wordpress installation: 
//				your_wordpress/wp-content/themes/unzipped_optimizepress2_theme_goes_here
//
//	2. move/copy this file (install.php) at location:
//		your_wordpress/wp-content/themes/optimizepress2_theme/lib/admin
//
//	3. login into your WP:
//		http://wordpress.local/wp-admin/
//
//	4. enter some dummy text in the API dialog
//
//	5. enjoy
...
class OptimizePress_Install {
	...
	function admin_menu(){
		...
		$page = add_menu_page('OptimizePress', 'OptimizePress', 'edit_theme_options', OP_SN, array($this,'install_screen'),'','30');
	...
	function print_styles(){
		...
		wp_enqueue_style( OP_SN.'-admin-common',  OP_CSS.'common.css', false, '2011-10-05' );
	}
			...
			if($ext){
				...
				if(isset($config['images'])){
					...
					foreach($images as $path => $file){
						...
						$file_array = array(
								'name' => $file,
								'tmp_name' => OP_LIB . 'content_layouts/working/' . $file
						);
