...
class OP_Content_Layout_Upgrader extends WP_Upgrader {
	...
	function upgrade_strings() {
		...
		$this->strings['remove_old'] = __('Removing old content template files.');
		$this->strings['process_failed'] = __('Content template update failed.');
		$this->strings['process_success'] = __('Content template updated successfully.');
	}

	function install_strings() {
		$this->strings['no_package'] = __('Install content template not available.');
		$this->strings['downloading_package'] = __('Downloading install package from <span class="code">%s</span>&#8230;');
		$this->strings['unpack_package'] = __('Unpacking the package&#8230;');
		$this->strings['installing_package'] = __('Installing the content template&#8230;');
		$this->strings['process_failed'] = __('Content template install failed.');
		$this->strings['process_success'] = __('Content template installed successfully.');
		$this->strings['missing_config'] = __('Content template config file is missing.');
		$this->strings['missing_image'] = __('Content template thumbnail image is missing.');
		$this->strings['remove_old'] = __('Removing old template layout files.');
	}
