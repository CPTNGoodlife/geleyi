...
<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
		...
		<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
			<div id="layout-settings-alongside" class="link-color-container cf layout-settings"<?php echo ($name=='alongside' ? '':' style="display:none"')?>>
				...
				<div class="color-chooser">
					...
					<p class="micro-copy">Choose the colour for the main text links on your navigation bar</p>
				...
				<div class="color-chooser">
					...
					<p class="micro-copy">Choose the hover colour for the main text links on your navigation bar</p>
				...
				<div class="color-chooser">
					...
					<p class="micro-copy">Choose the hover background colour for your main navigation bar (this will be used for the background hover state)</p>
				...
				<div class="color-chooser">
					...
					<p class="micro-copy">Choose the colour for the dropdown text links on your navigation bar</p>
				...
				<div class="color-chooser">
					...
					<p class="micro-copy">Choose the hover colour for the dropdown text links on your navigation bar</p>
			...
			<div id="layout-settings-below"<?php echo ($name=='below' ? '':' style="display:none"')?> class="link-color-container cf layout-settings">
				...
				<div class="color-chooser">
					...
					<p class="op-micro-copy">Choose the start (top) colour for the gradient on your navigation bar. For a solid colour leave the end colour blank</p>
				...
				<div class="color-chooser">
					...
					<p class="op-micro-copy">Choose the end (bottom) colour for the gradient on your navigation bar</p>
				...
				<div class="color-chooser">
					...
					<p class="op-micro-copy">Choose the hover start (top) colour for the gradient on your main navigation bar. For a solid colour leave the end colour blank</p>
				...
				<div class="color-chooser">
					...
					<p class="op-micro-copy">Choose the hover end (bottom) colour for the gradient on your main navigation bar</p>
	...
	<div class="op-bsw-grey-panel section-bottom">
		...
		<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
			...
			<p class="micro-copy">Select or enter a colour for the text link in the top navigation bar</p>
