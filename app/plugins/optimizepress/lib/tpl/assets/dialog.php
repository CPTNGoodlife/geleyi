<div id="op_asset_browser_container" style="display:none">
	<ul id="op_asset_browser_slider">
    	...
    	<li id="op_asset_browser_slide1" class="op_asset_browser_slide">
			...
			echo '
            <div class="asset-title cf"><a href="#" class="op-slide-link" style="opacity:0.5;pointer-events: none;cursor: default;"></a></a><span class="title-text">'.__('Insert an Element',OP_SN).'</span><div class="help-vid-link tooltip animated pulse" title="Help">'.op_asset_help_vid('step_1',true).'</div></div>
    	...
    	<li id="op_asset_browser_slide2" class="op_asset_browser_slide">
        	<div class="op_asset_content">
        		<div class="asset-title cf"><a href="#1" class="op-slide-link tooltip animated pulse" title="Choose a Different Element"></a><span class="title-text"><?php _e('Choose the Element Style')?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_2') ?></div></div>
        		<!--<div class="asset-second"><a href="#1" class="op-slide-link"><?php _e('&larr; Back to Choose an Element')?></a></div>-->
            </div>
        </li>
    	<li id="op_asset_browser_slide3" class="op_asset_browser_slide">
        	<div class="op_asset_content">
        		<div class="asset-title cf"><a href="#2" class="op-slide-link tooltip animated pulse" title="Choose a Different Element Style"></a><span class="title-text"><?php _e('Step 3')?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_3') ?></div></div>
    	...
    	<li id="op_asset_browser_slide4" class="op_asset_browser_slide">
        	<div class="op_asset_content">
        		<div class="asset-title cf"><a href="#3" class="op-slide-link tooltip animated pulse" title="Choose a Different Element Setting"></a><span class="title-text"><?php _e('Step 4')?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_4') ?></div></div>
            </div>
        </li>
    </ul>
